...
import logoAr from "../../../style/images/logoUNX-ar.svg";
import logoIcon from "../../../style/images/logo_icon.svg";
...
export default function Header() {
  const { t, i18nInstance, direction } = useI18n("Header");
  ...
  return (
    <>
      <header className="header">
        {direction !== "rtl" && <img src={logo} alt="logo" />}
        {direction === "rtl" && (
          <div>
            <img src={logoIcon} alt="logo" className="h-100 m_r_16" />
            <img src={logoAr} alt="logo" className="logo_ar" />
          </div>
        )}
        {/* <img src={direction === "rtl" ? logoAr : logo} alt="logo" /> */}
