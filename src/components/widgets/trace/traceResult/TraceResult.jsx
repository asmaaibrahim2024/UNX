                      ...
                      <div className="color-picker-popup" onClick={(e) => e.stopPropagation()}>
                        <div className="symbol-properties">
                          ...
                          <div className="section-size">
                            ...
                            <div className="input-row">
                              <input
                                type="number"
                                min="1"
                                value={traceConfigHighlights[`${startingPointId}${traceId}`]?.strokeSize || strokeSizes}
                          ...
                          <div className="section">
                            <HexColorPicker
                              color={traceConfigHighlights[`${startingPointId}${traceId}`]?.lineColor || colorPreview}
                          ...
                          <div className="section color-preview">
                            ...
                            <button
                              ...
                              onClick={() => handleSetHexValue(`${startingPointId}${traceId}`, hexValuePreview)}
                            >
                              ✓
                            </button>
                          </div>
                            ...
                            <input
                                ...
                                style={{
                                  background: `linear-gradient(to right, 
                                    ${hexToRgba(traceConfigHighlights[`${startingPointId}${traceId}`]?.baseColor  || '#4F46E5', 1)} 0%, 
                                    ${hexToRgba(traceConfigHighlights[`${startingPointId}${traceId}`]?.baseColor  || '#4F46E5', 0)} 100%)`,
                                  '--thumb-color': traceConfigHighlights[`${startingPointId}${traceId}`]?.baseColor  || '#4F46E5'
                                }}
