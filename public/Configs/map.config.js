window.mapConfig = {
  portalUrls: {
    ...
    // utilityNetworkLayerUrl:
    //   "https://utilitykit.eastus.cloudapp.azure.com/server/rest/services/utility/utilityNetwork/FeatureServer/0",
    // utilityNetworkLayerUrl:
    //   "https://utilitykit.eastus.cloudapp.azure.com/server/rest/services/Gas/Gas/FeatureServer/8",
  ...
  ApiSettings: {
    ...
    endpoints: {
      GetNetworkServiceById: "api/Unx/GetNetworkServiceById/",
      GetNetworkLayersByNetowkrServiceId:
        "api/Unx/GetNetworkLayersByNetowkrServiceId/",
      GetLayerFieldsByNetworkLayerId: "api/Unx/GetLayerFieldsByNetworkLayerId/",
    },
  },
};
